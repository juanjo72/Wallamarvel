...
extension ScreenTransition {
    static var detailPush: ScreenTransition {
        ScreenTransition(from: HeroesController.self, to: HeroeDetailViewController.self, type: .push, transition: ImageTransition())
    }
    
    static var detailPop: ScreenTransition {
        ScreenTransition(from: HeroeDetailViewController.self, to: HeroesController.self, type: .pop, transition: ImageTransition())
    }
}
